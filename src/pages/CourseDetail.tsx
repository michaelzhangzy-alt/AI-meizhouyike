          ...
          <div className="container mx-auto px-4 py-8 md:py-12">
            <div className="flex flex-col md:flex-row gap-8 items-start">
              ...
              <div className="w-full md:w-1/3 lg:w-2/5">
                <div className="aspect-video rounded-xl overflow-hidden shadow-lg bg-muted relative">
                  <img 
                ...
                <div className="mb-auto">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
                    <div className="flex items-center text-foreground">
                      ...
                      <div>
                        <span className="text-xs text-muted-foreground block">上课时间</span>
                    ...
                    <div className="flex items-center text-foreground">
                      ...
                      <div>
                        <span className="text-xs text-muted-foreground block">上课地点</span>
                    ...
                    <div className="flex items-center text-foreground">
                      ...
                      <div>
                        <span className="text-xs text-muted-foreground block">主讲导师</span>
                    ...
                    <div className="flex items-center text-foreground">
                      ...
                      <div>
                        <span className="text-xs text-muted-foreground block">课程状态</span>
                        <span className={`font-medium ${isPast ? 'text-muted-foreground' : 'text-green-600'}`}>
                          {isPast ? '已结束' : '报名中'}
                        </span>
                      </div>
                    </div>
          ...
          <div className="flex flex-col lg:flex-row gap-12">
            <div className="lg:w-2/3 space-y-12">
              ...
              <section className="bg-card rounded-xl p-8 shadow-sm border border-border">
                ...
                <div 
                  className="prose prose-lg max-w-none text-muted-foreground rich-text-content dark:prose-invert"
              ...
              <section className="bg-card rounded-xl p-8 shadow-sm border border-border">
                ...
                <div className="space-y-6">
                    <div>
                        <h4 className="font-bold text-foreground mb-2">如何观看直播？</h4>
                        <p className="text-muted-foreground">报名成功后，助教老师会邀请您加入专属学习群，直播链接将在群内发布。</p>
                    </div>
                    <div>
                        <h4 className="font-bold text-foreground mb-2">课程有回放吗？</h4>
                        <p className="text-muted-foreground">直播结束后会提供回放视频，您可以随时通过本网站的“往期课程”栏目查看。</p>
                    </div>
                    <div>
                        <h4 className="font-bold text-foreground mb-2">零基础可以学习吗？</h4>
                        <p className="text-muted-foreground">我们的公开课主要面向大学生和初学者，内容通俗易懂，非常适合零基础同学入门。</p>
                    </div>
                </div>
              </section>
            </div>
            ...
            <aside className="lg:w-1/3 space-y-8">
              <div className="bg-primary rounded-xl p-8 text-primary-foreground text-center shadow-lg">
                <h3 className="font-bold text-xl mb-2">加入学习社群</h3>
                <p className="text-primary-foreground/80 mb-6">获取课件、源码，结识更多 AI 爱好者</p>
                <Button 
                    className="w-full bg-background text-primary hover:bg-background/90 border-none"
               ...
               <div className="bg-card rounded-xl p-6 shadow-sm border border-border">
                  <h3 className="font-bold text-lg mb-4 text-foreground">讲师介绍</h3>
                  <div className="flex items-center mb-4">
                      <div className="w-12 h-12 bg-muted rounded-full flex items-center justify-center text-xl font-bold text-muted-foreground">
                          {course.instructor[0]}
                      </div>
                      <div className="ml-3">
                          <div className="font-bold text-foreground">{course.instructor}</div>
                          <div className="text-xs text-muted-foreground">资深 AI 讲师</div>
                      </div>
                  </div>
